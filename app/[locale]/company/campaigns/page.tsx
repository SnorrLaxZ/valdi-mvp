                ...
                <div className="flex justify-between items-start mb-4">
                  <div className="flex-1">
                    ...
                    <div className="flex gap-6 text-xs text-gray-500">
                      <span>€{campaign.commission_per_meeting} {t('common.perMeeting')}</span>
                      <span>{t('common.created')} {new Date(campaign.created_at).toLocaleDateString(locale === 'sv' ? 'sv-SE' : 'en-US')}</span>
                    </div>
                  </div>
                </div>
