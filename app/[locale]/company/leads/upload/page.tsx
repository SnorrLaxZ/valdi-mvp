...
function LeadUploadPageContent() {
  ...
  return (
    ...
    >
      <div className="max-w-4xl">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-2xl font-semibold text-gray-900">{t('leads.upload.title')}</h1>
          <p className="text-sm text-gray-500 mt-1">{t('leads.upload.description')}</p>
        </div>

        {uploaded ? (
          <div className="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
            <CheckCircle2 className="h-12 w-12 text-green-600 mx-auto mb-4" />
            <h2 className="text-lg font-semibold text-green-900 mb-2">{t('common.uploadSuccessful')}</h2>
            <p className="text-sm text-green-700 mb-4">
              {t('leads.upload.success', { count: uploadCount })}
            </p>
            ...
            {file && selectedCampaignId && (
              <div className="flex justify-end">
                <Button
                  ...
                  className="px-6"
                >
                  {uploading ? t('common.uploading') : t('leads.upload.title')}
                </Button>
              </div>
            )}
          </div>
