            ...
            {selectedMeeting && (
              <div className="lg:col-span-2 space-y-6">
                ...
                {selectedMeeting.campaigns && (() => {
                  const criteria = getQualificationCriteria(selectedMeeting.campaigns?.meeting_criteria || '[]')
                  const checklistValue = selectedMeeting.qualification_checklist
                  const checklist: boolean[] = Array.isArray(checklistValue) 
                    ? checklistValue.filter((v): v is boolean => typeof v === 'boolean')
