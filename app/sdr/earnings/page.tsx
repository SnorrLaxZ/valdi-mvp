  ...
  return (
    <div className="flex min-h-screen bg-white">
      ...
      <main className="flex-1 ml-64 p-8 bg-white">
        {/* Header */}
        <div className="mb-10">
          <h1 className="text-2xl font-semibold text-gray-900">Intjäning</h1>
          <p className="text-sm text-gray-500 mt-1">Översikt över dina intäkter och betalningar</p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-6 mb-10">
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <div className="text-xs text-gray-500 mt-1">{stats.qualifiedMeetings} godkända möten</div>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <div className="text-xs text-gray-500 mt-1">Under granskning eller väntar på betalning</div>
          </div>

          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <div className="text-xs font-medium text-gray-500 uppercase tracking-wide mb-2">Betald</div>
            <div className="text-3xl font-semibold text-green-600">€{stats.paidEarnings}</div>
            <div className="text-xs text-gray-500 mt-1">Utbetald</div>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg">
          <div className="p-6 border-b border-gray-200">
            <h2 className="text-lg font-semibold text-gray-900">Intjäningshistorik</h2>
          </div>
          <div className="p-6">
            {meetings.length === 0 ? (
              <div className="text-center py-16">
                <p className="text-sm text-gray-400">Inga möten ännu</p>
                <Link
                    ...
                    <div key={meeting.id} className="border border-gray-200 rounded-lg p-4">
                      <div className="flex items-start justify-between">
                        ...
                        <div className="text-right ml-4">
                          ...
                          {isPaid && (
                            <div className="text-xs text-green-600 mt-1">Utbetald</div>
                          )}
                          {meeting.status === 'qualified' && !isPaid && (
                            <div className="text-xs text-yellow-600 mt-1">Väntar på betalning</div>
                          )}
                        </div>
                      </div>
                    </div>
