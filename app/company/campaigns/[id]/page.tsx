  ...
  return (
    ...
    >
        ...
        <div className="bg-white border border-gray-200 rounded-lg">
          ...
          <div className="p-4">
            {campaign.meetings && campaign.meetings.length > 0 ? (
              ...
              <p className="text-sm text-gray-400 italic text-center py-8">No meetings yet</p>
            )}
          </div>
        </div>
      )}
      ...
      {activeTab === 'sdrs' && (
        <div className="bg-white border border-gray-200 rounded-lg">
          <div className="p-4 border-b border-gray-200">
            <h2 className="text-lg font-medium text-gray-900">Assigned SDRs</h2>
          </div>
          <div className="p-4">
                  ...
                  .map((app) => (
                    <div key={app.id} className="flex items-center justify-between p-3 border border-gray-200 rounded-lg">
                      <div>
                        ...
                        <div className="text-sm text-gray-500">Applied: {new Date(app.applied_at).toLocaleDateString('sv-SE')}</div>
                      </div>
